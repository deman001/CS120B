...
typedef enum detect_eq_states { DEQInit, eqwait, eqsample} detect_eq_states;
...
volatile unsigned int i = 0; //timer tracking
Queue data; //Tracks amp and direction
data.QueueInit(2); //Only need to track 2 for Max Amp and Directional change
unsigned char Ping;
unsigned char EQDetect;
unsigned char ZeroCrossing; 
